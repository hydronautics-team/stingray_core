...
def generate_launch_description():
    ns_arg = DeclareLaunchArgument('ns', default_value='power')
    params_arg = DeclareLaunchArgument(
        'params_file',
        default_value=f"{get_package_share_directory('stingray_core_communication')}/params/power.params.yaml"
    )
